...
def main():
    ...
    from model.visual_flow_edit import configure_visual_flow
    ...
    while time.monotonic()-started < args.max_seconds and not (args.queue/'STOP').exists():
        ...
        try:
            ...
            Image.fromarray(source_rgb[0]).save(source_image)
            target_refs = [refs[1], refs[0]]
            ...
            result.update(timing=timing, conditioning=text_time, flow_edit=denoise.audit, fixed_head=False,
